...
import { BasicOperationComponent, CheckboxOperationComponent, ImageOperationComponent, LinkOperationComponent, TextFieldOperationComponent, TextOperationComponent, CircleOperationComponent, RectangleOperationComponent } from "./OperationComponents.js";

vi.mock("moveable", () => {
  return {
    default: class MoveableMock {
      constructor() {}
      updateTarget = vi.fn();
      updateRect = vi.fn();
