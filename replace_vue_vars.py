...
def update_vue():
    with open('src/components/ImageDialog.vue', 'r') as f:
        content = f.read()

    # Apply the same replacements for the CSS block inside ImageDialog.vue
    replacements = {
    ...
    # We only want to replace inside <style>
    ...
    with open('src/components/ImageDialog.vue', 'w') as f:
        f.write(content)
